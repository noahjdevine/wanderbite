  ...
  public: {
    Tables: {
      ...
      bite_notes: {
        ...
        Relationships: [
          {
            foreignKeyName: "bite_notes_redemption_id_fkey"
      ...
      challenge_cycles: {
        ...
        Relationships: [
          {
            foreignKeyName: "challenge_cycles_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "user_profiles"
            referencedColumns: ["id"]
      ...
      challenge_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "challenge_items_cycle_id_fkey"
            columns: ["cycle_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "challenge_items_swapped_from_item_id_fkey"
            columns: ["swapped_from_item_id"]
            isOneToOne: false
      ...
      restaurant_orgs: {
        ...
        Relationships: [
          {
            foreignKeyName: "restaurant_orgs_market_id_fkey"
            columns: ["market_id"]
            isOneToOne: false
      ...
      restaurants: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "restaurant_orgs"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Functions: {
      ...
      fail_stripe_event: {
        Args: { p_event_id: string; p_error: string; p_token: string }
        Returns: boolean
      }
      fail_webhook_outbox: {
